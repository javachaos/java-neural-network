...
./mvnw -q -pl examples -am compile

CLASSPATH="examples/target/classes:core/target/classes:shared/target/classes"
...
exec java -cp "$CLASSPATH" \
  com.github.javachaos.javaneuralnetwork.examples.ConnectFourInteractiveDemo
